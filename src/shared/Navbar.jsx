...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-purple-700 text-white shadow-md sticky top-0 z-10">
      <div className="navbar-start">
        <Link to="/" className="btn btn-ghost text-xl text-white">
          Task<span className="text-yellow-300 font-bold">Go...</span>
        </Link>
      </div>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          <li>
            <Link to="/" className="text-xl font-bold hover:text-green-500">
              Home
            </Link>
          </li>
          {user && (
            <li>
              <Link to="/dashboard" className="text-xl font-bold hover:text-green-500">
                Dashboard
              </Link>
            </li>
          )}
...
//         {/* Logo */}
//         <Link to="/" className="btn btn-ghost text-xl text-white">
//           Task<span className="text-3xl text-yellow-300 font-bold">Go</span>
//         </Link>
//       </div>
